...
<http://numba.pydata.org/numba-doc/0.6/index.html>`_ and `Blaze
<http://continuum.io/blog/blaze>`_.
...
.. note::
   ...
   but see :ref:`multiple_pythons` for more information on managing this situation.
