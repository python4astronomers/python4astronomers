...
extern "C" {
  ...
  extern void beta1d(double *x, int num,
		     double *pars, double **res);
  extern void gauss1d(double *x, int num,
		      double *pars, double **res);

  extern void beta2d(double *x0, double *x1, int num,
		     double *pars, double **res);
  extern void gauss2d(double *x0, double *x1, int num,
		      double *pars, double **res);
...
int beta1d_proto(const double* p,
  ...
  beta1d((double*)x, (int)xsize, (double*)p, (double**)&y);
...
int gauss1d_proto(const double* p,
  ...
  gauss1d((double*)x, (int)xsize, (double*)p, (double**)&y);
...
int beta2d_proto(const double* p,
  ...
  beta2d((double*)x0, (double*)x1, (int)x0size, (double*)p, (double**)&y);
...
int gauss2d_proto(const double* p,
  ...
  gauss2d((double*)x0, (double*)x1, (int)x0size, (double*)p, (double**)&y);
