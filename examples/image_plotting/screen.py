                  ...
                  # xemacs screen.py  # select Courier 14 bold font
                  # import screen.png  (from upper left, cropping at bottom and right)
                  # convert screen.png -negate screen_black.png
                  # composite screen_black.png plot.png -gravity center -compose plus aplpy.png
